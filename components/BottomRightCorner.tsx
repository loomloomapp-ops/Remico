...
export default function BottomRightCorner({ ready = true }: { ready?: boolean }) {
  return (
    <motion.a
      href="#products"
      ...
      className="absolute bottom-0 right-0 p-3 pt-5 pl-8 sm:p-4 sm:pt-6 sm:pl-10 md:p-6 md:pt-8 md:pl-14 bg-paper rounded-tl-[1.5rem] sm:rounded-tl-[2rem] md:rounded-tl-[3.5rem] flex items-center gap-3 sm:gap-4 md:gap-6 cursor-pointer group"
    >
      ...
      <div className="flex flex-col">
        <span className="text-[15px] md:text-[20px] font-bold text-ink">
          Каталог продукції
        </span>
