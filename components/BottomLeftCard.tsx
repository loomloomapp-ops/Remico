...
export default function BottomLeftCard({ ready = true, light = false }: { ready?: boolean; light?: boolean }) {
  const cls =
    "absolute bottom-28 right-4 left-auto md:left-6 md:right-auto md:bottom-6 lg:bottom-10 lg:left-10 p-3 md:p-4 lg:p-5 rounded-[1.2rem] md:rounded-[1.5rem] lg:rounded-[2.2rem] bg-white/80 md:bg-white/60 md:backdrop-blur-xl border border-white/50 flex flex-col gap-2 lg:gap-3 min-w-[150px] md:min-w-[160px] lg:min-w-[200px] w-fit shadow-card";
